...
| Notebook 01 de análisis | ⏳ pendiente (falta definir foco) |
...
1. **Notebook 01 de análisis** (leyendo desde `pruebas_aprender/parquet/`). Falta definir el foco:
   evolución de desempeños, brechas por sector/ámbito, desempeño vs. contexto socioeconómico (NSE /
   nivel educativo del hogar), etc.
2. (Opcional) Afinar la clasificación de las variables `tipo_variable == 'otro'`.
3. (Opcional) Integrar los microdatos `.sav` 2024 (requiere `pyreadstat`, no instalado aún).
...
| 4 | 2026-08-31 | Auditoría de los datos descargados del Drive (íntegros, firma `c9740263478b`); documentación de traspaso (este archivo). |
